      ...
      <div className="flex-about">
        <div className="about-text">
          ...
          <p>
            ...
            development tools and frameworks, including React, Nextjs, and
            Node.js. I am always eager to learn and explore new technologies,
            and I am constantly seeking out opportunities to improve my skills
            and knowledge.
          </p>
        </div>
